    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        grievance_submit.setOnClickListener(v -> {
            ...
            if (issue.getText().toString().isEmpty()) {
                //Toasty.normal(Grievance.this, "Issue cannot be empty", R.drawable.iea_logo).show();
                Toast.makeText(Grievance.this, "Issue cannot be empty", Toast.LENGTH_SHORT).show();
                issue.requestFocus();
            } else if (dept.getText().toString().isEmpty()) {
                //Toasty.normal(Grievance.this, "Department cannot be empty", R.drawable.iea_logo).show();
               ...
               // Toasty.normal(Grievance.this, "Subject cannot be empty", R.drawable.iea_logo).show();
                ...
                grievanceReference2 = grievanceDb.getReference("Unresolved Grievances").child(Objects.requireNonNull(complainerEmail).replaceAll("\\.", "%7")).child(Objects.requireNonNull(grievanceKey));
